...
- [Read on GitHub Pages](https://little-book-of.github.io/c23/) — online website
...
Nguyen, Duc-Tam (2025). *The Little Book of C (v0.1.0).* 

```
@book{Nguyen2025TLBoC,
  author = {Duc-Tam Nguyen},
  title  = {The Little Book of C23},
  year   = {2025},
  note   = {Version 0.1.0},
  url    = {https://github.com/little-book-of/c23/}
}
```
